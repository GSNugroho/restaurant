...
<div class="content-wrapper">
        ...
        <div class="row">
          <div class="col-12">
            <div class="row">
                ...
                <div class="col-2">
                    <a class="btn btn-block btn-secondary" href="<?php echo base_url().'Produk/tambah_stok'?>">Tambah Stok Masuk</a>
    ...
    $(document).ready(function() {
      var table = $('#tbl_stok_in').DataTable({
          ...
          'serverMethod': 'post',
          'ajax': {
              'url': '<?php echo base_url().'Produk/tbl_stok_in'?>',
          },
          'columns': [
              {
    ...
    <!-- Modal -->
            ...
            <div class="modal-body">
              <table>
                <tr>
                  ...
                  <td>:</td>
                  <td><span id="stok_in_dt_masuk"></span></td>
                </tr>
                <tr>
                  <td><i class="nav-icon fas fa-user-edit"></i></td>
                  <td>:</td>
                  <td><span id="stok_in_user_create"></span></td>
                </tr>
              </table>
              ...
              <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-right">HARGA JUAL PER UNIT</th>
                      <th class="text-right">TOTAL HARGA JUAL</th>
                    </tr>
                  </thead>
                  <tbody id="detail_tbl_stok_in">
                  </tbody>
                </table>
            </div>
      ...
      <script>
        ...
        $('#modal-default').on('show.bs.modal', function(event) {
          ...
          $.get("<?php echo base_url().'Produk/get_detail_stok_masuk'?>", dataString, function(data){
