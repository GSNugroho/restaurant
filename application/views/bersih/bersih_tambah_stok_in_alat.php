    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
                <form action="<?php echo base_url().'Bersih/tambah_stok_in_baru_alat';?>" method="post" enctype="multipart/form-data" autocomplete="off">
                  <div class="col-sm-12">
                  <br>
                    <table>
                      <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><a href="<?php echo base_url().'Bersih/stok_in_alat'?>" type="button" class="btn btn-block btn-outline-danger">Batal</a></td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-6">
                    ...
                    <table class="table table-borderless">
                        <thead>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <input class="form-control" id="produk_nm" name="produk_nm[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                ...
                                <td>
                                    <div class="form-group">
                                        <input class="form-control" id="produk_satuan" name="produk_satuan[]">
                                    </div>
                                </td>
                                <td>
                                    <div class="form-group">
                                        <input class="form-control" type="text" id="produk_harga" name="produk_harga[]" style="text-align: right;">
                                    </div>
                                </td>
        ...
        $('#button_tambah').on('click', function(){
            ...
            $(wrapper).append(`
                <tr>
                    <td>
                        <div class="form-group">
                            <input class="form-control" type="text" id="produk_nm${count}" name="produk_nm[]">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                    ...
                    <td>
                        <div class="form-group">
                            <input class="form-control" type="text" id="produk_satuan${count}" name="produk_satuan">
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <input class="form-control" type="text" id="produk_harga${count}" name="produk_harga[]" style="text-align: right;">
                        </div>
                    </td>
                    <td style="text-align: right;">
