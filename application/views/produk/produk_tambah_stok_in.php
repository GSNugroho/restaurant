    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
                <form action="<?php echo base_url().'Produk/tambah_stok_in_baru';?>" method="post" enctype="multipart/form-data" autocomplete="off">
                  <div class="col-sm-12">
                  <br>
                    <table>
                      <tr>
                        <td><button type="submit" class="btn btn-block btn-success">Simpan</button></td>
                        <td><a href="<?php echo base_url().'Administrator/stok_in'?>" type="button" class="btn btn-block btn-outline-danger">Batal</a></td>
                      </tr>
                    </table>
                  </div>
                  <div class="col-6">
                    ...
                    <table class="table table-borderless">
                        <thead>
                            <tr>
                                ...
                                <th>SATUAN</th>
                                <th style="display:none;">HARGA BELI PER UNIT</th>
                                <th style="display:none;">TOTAL HARGA BELI</th>
                                <th></th>
                            </tr>
                            <tr>
                                <td>
