        ...
        $('#modal-confim').on('show.bs.modal', function(event) {
          ...
          for(var z=0; z < data.length; z++){
            ...
            html += `<tr>
              ...
              <td>${data[z][1]}</td>
              <td>
                <select class="form-control" name="${data[z][0]}" id="${data[z][0]}">
                    <option value="0">Sambal Bawang</option>
                    <option value="1">Sambal Terasi Tomat</option>
                    <option value="2">Sambal Terasi Plecit</option>
                </select>
              </td>
